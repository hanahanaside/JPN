          ...
          case SQLITE_CONFIG_PCACHE:
            {
              ...
              MyDebugger.Break(); // TODO --sqlite3GlobalConfig.pcache = (sqlite3_pcache_methods)va_arg(ap, "sqlite3_pcache_methods");
              break;
            }
          ...
          case SQLITE_CONFIG_GETPCACHE:
            {
              ...
              MyDebugger.Break(); // TODO -- *va_arg(ap, sqlite3_pcache_methods) = sqlite3GlobalConfig.pcache;
              break;
            }
