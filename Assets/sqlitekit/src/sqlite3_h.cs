...
namespace Community.CsharpSqlite
{
  public partial class Sqlite3
  {
    ...
    */
	...
	static void SQLITE_STATIC_ZERO( ref string pDelArg ){}
	static void SQLITE_TRANSIENT_ONE( ref string pDelArg ){}
    static public dxDel SQLITE_STATIC = SQLITE_STATIC_ZERO;
    static public dxDel SQLITE_TRANSIENT = SQLITE_TRANSIENT_ONE;
