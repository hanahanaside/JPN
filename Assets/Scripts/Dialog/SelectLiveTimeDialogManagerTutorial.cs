...
public class SelectLiveTimeDialogManagerTutorial : MonoSingleton<SelectLiveTimeDialogManagerTutorial> {
	...
	public void On1MinuteClicked(){
		FenceManager.instance.HideFence ();
		LiveManagerTutorial.instance.StartLive (10.0f);
	...
	public void On8HoursClicked(){
		FenceManager.instance.HideFence ();
		LiveManagerTutorial.instance.StartLive (60.0f);
